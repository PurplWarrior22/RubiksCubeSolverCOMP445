...
public class Cube {
	...
	public String toString() {
		String returnString = "U: ";
		returnString = returnString + toStringFace(upFace) + "\n";
		returnString = returnString + "L: " + toStringFace(leftFace) + "\n";
		returnString = returnString + "F: " + toStringFace(frontFace) + "\n";
		returnString = returnString + "D: " + toStringFace(downFace) + "\n";
		returnString = returnString + "R: " + toStringFace(rightFace) + "\n";
		returnString = returnString + "B: " + toStringFace(backFace) + "\n";
	...
	public void printCube() {
		// System.out.printf("%10s %10s %10s", "Rubik", "'s", "Cube");
		// System.out.println("");
		System.out.println(toStringFace(upFace));
		String line = "";

		for (int i = 0; i < 3; i++) {
			line = line + leftFace[i][0].getColor() + leftFace[i][1].getColor() + leftFace[i][2].getColor() + " "
					+ frontFace[i][0].getColor() + frontFace[i][1].getColor() + frontFace[i][2].getColor() + " "
					+ rightFace[i][0].getColor() + rightFace[i][1].getColor() + rightFace[i][2].getColor() + " "
					+ backFace[i][0].getColor() + backFace[i][1].getColor() + backFace[i][2].getColor() + "\n";
		}
		System.out.println(line);

		System.out.println(toStringFace(downFace));
